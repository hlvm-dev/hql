...
import { SList, SSymbol } from "../../s-exp/types.ts";
import {
  hasHashMapPrefix,
  hasVectorPrefix,
  isSymbolWithName,
...
/**
 * Transform a 'const' expression (immutable binding).
 * Handles both forms:
...
/**
 * Transform a 'let' expression (mutable, block-scoped binding).
 * Handles both forms:
 * 1. (let name value) - Global mutable binding
