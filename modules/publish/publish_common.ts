 ...
 * If a version is provided, returns that.
 * Otherwise, if no VERSION file exists, creates one with "0.0.1";
 * if it exists, bumps the patch number.
 */
 ...
 * First, checks the NPM_USERNAME environment variable; if not set, runs "npm whoami".
 */
