import { 
    HQLValue, HQLSymbol, HQLList, HQLFn, HQLMacro, 
    makeNil, makeNumber, makeString, makeBoolean, makeSymbol, HQLEnumCase, makeList
  } from "./type.ts";
  ...
  function evaluateAtom(ast: HQLValue, env: Env): HQLValue {
    ...
    if (["number", "string", "boolean", "nil", "list"].includes(ast.type)) return ast;
    return ast;
  }
