...
> **This is a template README automatically generated by [HQL Publish](https://github.com/hlvm-dev/hql).**
...
This is a module published with [HQL](https://github.com/hlvm-dev/hql).
...
\`\`\`
See [HQL Publish Guide](https://github.com/hlvm-dev/hql) for full details.
...
- [HLVM Documentation](https://github.com/hlvm-dev/hql)
