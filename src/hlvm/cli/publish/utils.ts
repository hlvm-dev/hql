 ...
 */
export interface HqlPackageConfig extends Record<string, unknown> {
  name: string;
  version: string;
  exports?: string;
  description?: string;
 ...
 */
export async function ensureReadme(projectPath: string, config: HqlPackageConfig): Promise<void> {
...
> **This is a template README automatically generated by [HQL Publish](https://github.com/hlvm-dev/hlvm).**
...
This is a module published with [HQL](https://github.com/hlvm-dev/hlvm).
...
\`\`\`
See [HQL Publish Guide](https://github.com/hlvm-dev/hlvm) for full details.
