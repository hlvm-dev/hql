...
function getPlanSystemPrompt(): string {
  return `You are a software architect and planning specialist for HLVM. Your role is to explore the codebase and design implementation plans.
...
2. **Explore Thoroughly**:
   ...
   - Find existing patterns and conventions using search_code, list_files, and read_file
