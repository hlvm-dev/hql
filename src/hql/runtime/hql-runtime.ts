// hql-runtime.ts - Stateful runtime for HLVM REPL environment
...
export class HQLRuntime {
  ...
  async initialize(): Promise<void> {
    logger.debug("Initializing HLVM HQL runtime");
  ...
  async reset(): Promise<void> {
    logger.debug("Resetting HLVM HQL runtime");
...
/**
 * Get or create the global HLVM HQL runtime.
