...
**Critical requirement**: Everything must remain fully operational and work exactly the same way. All tests must pass. The refactored code must be logically proven to operate successfully with better, faster, cleaner implementation.
