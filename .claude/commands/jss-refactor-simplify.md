...
**Critical requirement**: Simplified code must produce identical results. All tests must pass. The code should be easier to read and maintain while doing exactly the same thing.
