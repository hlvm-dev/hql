...
import { Env, baseEnv } from "./env.js";
import { evaluateAsync } from "./eval.js";
import { makeNil } from "./type.js";
import { realPathSync, dirname, relative } from "../platform/platform.js";
export async function compileHQL(source, inputPath, skipEvaluation = false) {
